...
(function () {
  function fixCrossLangTab() {
    var path = window.location.pathname;  // e.g. "/taichiknowledgebase/vi/..."
    var isVi = path.indexOf("/vi/") !== -1 || /\/vi(\/|$|\.)/.test(path);
    var crossLinks = document.querySelectorAll(".md-tabs__link[href*='taichiknowledgebase/'], .md-nav__link[href*='taichiknowledgebase/']");
    crossLinks.forEach(function (a) {
      ...
      if (isVi) {
        ...
        if (href.indexOf("/vi/index.html") !== -1 || href.indexOf("/vi/") !== -1) {
          a.setAttribute("href", "https://henryphamduc.github.io/taichiknowledgebase/en/index.html");
        }
      } else {
        // Currently on EN site (or root) -> point cross-link to VI site
        if (href.indexOf("/en/index.html") !== -1 || href.indexOf("/en/") !== -1) {
          a.setAttribute("href", "https://henryphamduc.github.io/taichiknowledgebase/vi/index.html");
        }
      }
    });
  }
